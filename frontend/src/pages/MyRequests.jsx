...
console.log("Requests.jsx component loaded");
...
const MyRequests = () => {
  ...
  return (
    <>
      <Intro heading="My Requests" description="Manage your book requests and notifications here." />

      <div className="min-h-screen">
        <div className="max-w-5xl mx-auto p-6">


          <div className="animate-themeAnimationLg bg-white rounded-xl shadow-md p-6 mb-8 border border-blue-100">
