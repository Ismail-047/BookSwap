...
const Wishlist = () => {
  ...
  const { userWishlist, removeBookFromWishlist } = useUserStore();
  ...
  if (!userWishlist || userWishlist?.length === 0) {
    return (
      <div className="animate-themeAnimationLg min-h-screen flex flex-col items-center justify-center py-16 px-4 rounded-xl border border-blue-100 shadow-sm">
  ...
  return (
    <>
      <Intro
        heading="My Wishlist"
        description="Books you' ve added to your wishlist will appear here. When a book becomes available,
      you'll receive a notification."
      />

      <div className="animate-themeAnimationLg p-6 rounded-xl">
