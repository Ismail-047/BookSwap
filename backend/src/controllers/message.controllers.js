...
export const createConversation = async (req, res) => {
    try {
        ...
        if (!userToChatId) return sendRes(res, 400, "Other participant id is required while creating a conversation.");
        ...
        if (conversation) {
            return sendRes(res, 200, "Conversation already exists.", conversation);
        }
        ...
        return sendRes(res, 201, "New conversation created successfully.", conversation);
    }
    catch (error) {
